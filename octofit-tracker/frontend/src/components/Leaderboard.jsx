...
function Leaderboard() {
  ...
  useEffect(() => { fetchItems('/api/leaderboard/').then((result) => setState({ ...result, loading: false, error: '' })).catch((error) => setState({ items: [], loading: false, configured: true, error: error.message })); }, []);
